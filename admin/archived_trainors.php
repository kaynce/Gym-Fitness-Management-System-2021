<?php 
 if (session_status() === PHP_SESSION_NONE){ 
  ...
  $nav_active_archived_users  = "nav-active";
          ...
          <header class="page-header">
            ...
            <div class="right-wrapper pull-right">
              <ol class="breadcrumbs">
                ...
                <li><span>Archived Users</span></li>
              </ol>
            ...
            <div class="col-xl-12">
                <section class="panel">
                  ...
                  <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Archived Users</h2>
                  </header>
                        ...
                        <colgroup>
                         ...
                         <tbody>
                             ...
                             <?php 
                              ...
                              $member = "SELECT *,concat(lastname,', ',firstname) AS name FROM users WHERE status ='archived' ORDER BY id DESC ";
                          ...
                          <tr class="center">
                              <!-- <th scope="row"><b></b></th> -->
                              <td class="center">
                                <a type="button" id="<?php echo $row['id']; ?>" class="btn-sm btn-success restore" ><i class="fa fa-check"></i>&nbsp;Restore</a>
                              </td>
                              <!-- <td>
        ...
        Swal.fire({
           title: 'Do you want to restore this trainor?',
            ...
            if (result.value) {
              ...
              $.ajax({                        
                  url:'ajax.php?action=restore_trainor_action',
                  type:'post',
                  data:{
                      id:id
                  },
            ...
            if(data == 1){
              ...
              Swal.fire({
                    ...
                    timer: 1500
                       ...
                       window.location.href = 'archived_trainors';
                  })
