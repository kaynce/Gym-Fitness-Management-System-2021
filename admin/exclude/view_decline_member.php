				...
				<div class="row">
					...
					<div class="row">
					 ...
					 <?php 
			           $id = $_GET['id'];
			           $i = 1;
			           $query = "SELECT *,concat(lastname,', ',firstname) AS name FROM pending_members WHERE status ='archived' AND id = '$id' ORDER BY concat(lastname,', ',firstname) desc ";
				            ...
				            <div class="col-md-12">
				                <section class="panel">
				                  <header class="panel-heading">
				                    ...
				                    <h2 class="panel-title"><a href="members_decline.php" class="fa fa-chevron-left">&nbsp; &nbsp;</a>View Info</h2>
				                  </header>
				                    ...
				                    <form class="form-horizontal form-bordered" method="get">
					                    ...
					                    <div class="form-group">
					                        ...
					                        <div class="">
					                            ...
					                            <img src="assets/images/users/screenshot_id/<?php echo $row['screenshot_id'];?>" alt="" class="img-responsive img-circle img-thumbnail" style="height: 100%;">
					                        </div>
					                      </div>  
