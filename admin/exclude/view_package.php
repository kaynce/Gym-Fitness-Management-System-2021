                ...
                <div class="card">
                         <form class="form-horizontal" action="">
                                <div class="card-body mb-2">
                                    ...
                                    <a href="packages.php"><button type="button" class="btn btn-secondary mb-1" >Back</button></a>
                                    <div class="row">

                                        <div class="col-6">                                         
                                            <label for="plan_name" class="text-right control-label col-form-label" >Package Name</label>
                                            <input type="text" class="form-control" readonly value="<?php echo $row['package_name'] ?>" >
                                              
                                        </div>

                                         <div class="col-6">
                                            <label for="description" class="text-right control-label col-form-label" >Description</label>
