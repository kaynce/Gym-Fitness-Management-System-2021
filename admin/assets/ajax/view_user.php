      ...
      <section class="panel">
        <header class="panel-heading">
          <h2 class="panel-title">
            <?php 
               if($row['type'] == 'admin'){
                  echo 'View Admin\'s Info';
               }else if($row['type'] == 'sub_admin'){
                  echo 'View Sub Admin\'s Info';
               }else{
                  echo 'View Trainor\'s Info';
               }
        ...
        <div class="panel-body">
            <form>
                  <div class="row show-grid">
                    <div class="col-md-6"><span class="show-grid-block text-uppercase text-semibold text-dark">
                    <?php 
                       if($row['type'] == 'admin'){
                          echo 'Admin ID';
                       }else if($row['type'] == 'sub_admin'){
          ...
          <div class="panel-body">
            <div class="table-responsive">
              <table class="table table-bordered table-striped mb-none" id="trainor_client_table">
                  ...
                  <?php 
                    ...
                    $i = 1;
                     $member = "SELECT DISTINCT 
                                              member_id FROM `enrolls_to` WHERE add_renew_status ='approved' AND trainor_id = '$user_id' AND status = '1' ORDER BY id DESC ";
                ...
                <tr>
                 <!--  <td class="center">
                    <a type="button" href="assets/ajax/view_trainor_client.php?member_id=<?php echo $row['member_id'] ?>" class="btn btn-sm btn-success modal-with-zoom-anim simple-ajax-modal  btn-sm btn-success" >View</a>
                  </td> -->
