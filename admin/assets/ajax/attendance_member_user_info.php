    ...
    <div class="panel-body">
      <form>
        <div class="row show-grid">
          <div class="col-md-6"><span class="show-grid-block text-uppercase text-semibold text-dark">Member ID: </span><?php echo substr($row['member_id'], 0, 3) ?>**</div>
...
<div id="custom-content" class="modal-block modal-block-lg">
      ...
      <section class="panel">
        ...
        <div class="panel-body">
            <form>
                  <div class="row show-grid">
                    <div class="col-md-6"><span class="show-grid-block text-uppercase text-semibold text-dark">User ID: </span><?php echo substr($row['user_id'], 0, 3) ?>**</div>
                    <div class="col-md-6"><span class="show-grid-block text-uppercase text-semibold text-dark" >Name: </span><?php echo $row['name']; ?></div>
                  </div>
                       ...
                       <table class="table table-bordered table-striped mb-none" id="trainor_client_table">
                         ...
                         <tbody>
                             ...
                             <?php 
                              ...
                              $query = "SELECT * FROM enrolls_to WHERE add_renew_status ='approved' AND trainor_id = '$user_id' ORDER BY id DESC";
