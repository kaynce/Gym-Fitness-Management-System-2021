<?php 
   ...
   $nav_active_gym_membership_pending = "nav-active";
 ?>
            ...
            <div class="right-wrapper pull-right">
              <ol class="breadcrumbs">
               ...
               <li><span>Gym Enrolled</span></li>
                <li><span>Gym Enrolled | Packages Pending</span></li>
              </ol>
                ...
                <section class="panel">
                  <header class="panel-heading">
                    <div class="panel-actions">
                      ...
                      <a href="walkin-packages-pending"><button type="button" class="mb-xs mt-xs mr-xs btn btn-default"><i class="fa fa-refresh"></i> Refresh</button></a>
                    </div>
            
                    <h2 class="panel-title">Walk In | Packages Pending </h2>
                    ...
                    <div class="table-responsive">
                      ...
                      <?php 
                        ...
                        if(isset($_SESSION['email'])){
                           ...
                           $member = "SELECT * FROM `enrolls_to` WHERE member_id = '$member_id' AND add_renew_status = 'pending' ORDER BY id desc ";
                      ...
                      ?>
                            <tr class="center">
                              <td class="center">
                                  <a type="button" href="assets/ajax/view_member_gym_membership_pending.php?id=<?php echo $row['id']; ?>" class="modal-with-zoom-anim simple-ajax-modal  btn-sm btn-info" ><i class="fa fa-folder-open"></i>&nbsp;View</a>
